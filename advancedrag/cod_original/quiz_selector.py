...
def display_quiz_selection():
    st.markdown("<h1 style='color:#96053e;'>Quiz Selector</h1>", unsafe_allow_html=True)
...
def display_question(question, question_number, total_questions):
    st.markdown(f"<h2 style='color: #96053e; font-weight: bold;'>Question {question_number} of {total_questions}</h2>",
                unsafe_allow_html=True)
    st.markdown(
        f"<p style='font-size: 18px; font-weight: 600; margin: 15px 0;'>{question['question']}</p>",
        unsafe_allow_html=True)
